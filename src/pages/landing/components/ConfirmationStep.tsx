    ...
    <div className="bg-nebula-white dark:bg-cosmic-grey dark:bg-opacity-20 rounded-xl p-8 md:p-12 shadow-lg">
      <div className="text-center mb-8">
        ...
        <p className="text-cosmic-grey dark:text-stardust">
          Your Chief Cognitive Officer is ready to be created with the following configuration:
        </p>
      </div>
      ...
      <div className="space-y-6 mb-8">
        ...
        <div>
          ...
          {selectedSources.length > 0 ? (
            ...
            <p className="text-cosmic-grey dark:text-stardust">No data sources selected (Empty Chief Cognitive Officer)</p>
          )}
        </div>
        ...
        >
          {isProcessing ? (
            <span className="flex items-center justify-center">
              ...
              Creating Your Chief Cognitive Officer...
            </span>
          ) : 'Create My Chief Cognitive Officer'}
        </button>
      </div>
    </div>
  );
