  ...
  return (
    <div className="bg-white dark:bg-midnight-blue min-h-screen flex flex-col transition-colors duration-300">
      <Head>
        ...
        <meta name="description" content="Create a new CCO account" />
      </Head>
          ...
          <div className="bg-white dark:bg-cosmic-grey rounded-xl shadow-xl overflow-hidden">
            <div className="p-8">
              <div className="text-center mb-8">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-nebula-white mb-2">Create Your Account</h1>
                <p className="text-gray-600 dark:text-stardust">Join the CCO platform</p>
              </div>

              {/* MVP Client Message */}
              <div className="mb-6 p-4 bg-electric-indigo/10 border border-electric-indigo/30 rounded-lg">
                <h3 className="font-semibold text-electric-indigo mb-2">MVP Client Access Only</h3>
                <p className="text-gray-700 dark:text-stardust text-sm">
                  Our platform is currently available exclusively to MVP clients. 
                  Please <a href="https://x.com/LamarDealMaker" target="_blank" rel="noopener noreferrer" className="text-electric-indigo hover:text-electric-indigo/80 transition-colors">contact us</a> to learn how to become an MVP client.
                </p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-nebula-white mb-1">
                    Full Name
                  </label>
                  <input
                    id="name"
                  ...
                  />
                  {errors.name && (
                    <p className="mt-1 text-sm text-electric-crimson">{errors.name}</p>
                  )}
                </div>
                ...
                <div>
                  <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-nebula-white mb-1">
                    Password
                  </label>
                  <input
                    id="password"
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 dark:text-nebula-white mb-1">
                    Confirm Password
                  </label>
                  <input
                    id="confirmPassword"
                  ...
                  />
                  {errors.confirmPassword && (
                    <p className="mt-1 text-sm text-electric-crimson">{errors.confirmPassword}</p>
                  )}
                </div>
